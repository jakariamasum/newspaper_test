...
type RowProps = {
  ...
  duplicateRow: (id: number, sections: string[], backgroundColor: string, color: string) => void;
...
const Row: React.FC<RowProps> = ({
  ...
  return (
    <div ref={ref} style={{ backgroundColor, color }} className="bg-white text-xs border-2 rounded-md border-main flex flex-col mb-4">
      <div className="flex justify-between items-center p-2 bg-main/10">
        ...
        <div className="flex items-center space-x-2">
          ...
          {showPopup && (
            <div className="fixed right-0 top-0 bottom-0 bg-white w-full md:w-96 z-[1000]">
              <div className='flex items-center justify-between p-2 bg-main/10'>
                ...
                <svg onClick={handlePopupClose} className="cursor-pointer text-red-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368 144 144m224 0L144 368"></path></svg>
          ...
          <button onClick={() => duplicateRow(id, sectionList, backgroundColor, color)}>
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M104.6 48H64C28.7 48 0 76.7 0 112V384c0 35.3 28.7 64 64 64h96V400H64c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H80c0 17.7 14.3 32 32 32h72.4C202 108.4 227.6 96 256 96h62c-7.1-27.6-32.2-48-62-48H215.4C211.6 20.9 188.2 0 160 0s-51.6 20.9-55.4 48zM144 56a16 16 0 1 1 32 0 16 16 0 1 1 -32 0zM448 464H256c-8.8 0-16-7.2-16-16V192c0-8.8 7.2-16 16-16l140.1 0L464 243.9V448c0 8.8-7.2 16-16 16zM256 512H448c35.3 0 64-28.7 64-64V243.9c0-12.7-5.1-24.9-14.1-33.9l-67.9-67.9c-9-9-21.2-14.1-33.9-14.1H256c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64z"></path></svg>
          </button>

          <svg className="cursor-pointer" fontSize={25} onClick={() => deleteRow(id)} stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M360 184h-8c4.4 0 8-3.6 8-8v8h304v-8c0 4.4 3.6 8 8 8h-8v72h72v-80c0-35.3-28.7-64-64-64H352c-35.3 0-64 28.7-64 64v80h72v-72zm504 72H160c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h60.4l24.7 523c1.6 34.1 29.8 61 63.9 61h454c34.2 0 62.3-26.8 63.9-61l24.7-523H888c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zM731.3 840H292.7l-24.2-512h487l-24.2 512z"></path></svg>
        </div>
      </div>
      <div className='block divide-y'>
        <div className='flex items-center space-x-2 p-2'>
          <button onClick={() => addSection('category')} className="bg-main px-2 py-1.5 leading-none rounded-md text-white">Category</button>
          <button onClick={() => addSection('offer')} className="bg-main px-2 py-1.5 leading-none rounded-md text-white">Offer</button>
          <button onClick={() => addSection('banner')} className="bg-main px-2 py-1.5 leading-none rounded-md text-white">Banner</button>
        </div>
