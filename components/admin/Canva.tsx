...
const Canva = () => {
  const [title, setTitle] = useState(
    "China Wholesale <br> <h>Cheap Hand Made</h> <br> Brazilian"
  );
    ...
    <div className="full">
      ...
      <div>
        ...
        >
          ...
          {!favicon && (
            <Image width={90} height={90} src={favicon} alt="Favicon" />
          )}
          {watermark && (
            <Image
              width={1080}
          ...
          {!photo && (
            <div
              style={{
                ...
                maskImage:
                  "url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/3/sun.svg)",
                maskSize: "100vmin",
        ...
        <button
          className="p-2 bg-main text-white text-center w-full mt-2"
          onClick={() => handleDownload(canvaRef3)}
        >
          Download
        </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {(selectedBox === "all" || selectedBox === "canvaRef1") && (
            <div className="flex flex-col">
              ...
              >
                ...
                <h1 className="text-6xl" style={{ color: titleColor }}>
                  {parseTitle(title)}
                </h1>
                <p
                  style={{ color: descriptionColor }}
              ...
              <button
                className="p-2 bg-main text-white text-center w-full mt-2"
                onClick={() => handleDownload(canvaRef1)}
              >
                Download
              </button>
            </div>
          ...
          {(selectedBox === "all" || selectedBox === "canvaRef2") && (
            <div className="flex flex-col">
              ...
              <button
                className="p-2 bg-main text-white text-center w-full mt-2"
                onClick={() => handleDownload(canvaRef2)}
              >
                Download
              </button>
            </div>
