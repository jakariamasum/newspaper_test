    ...
    <main>
      <div>
          ...
          <>
            <div className='flex items-center justify-between text-white'>
              ...
              <div className='flex items-center space-x-2'>
                <div className='hidden md:block'><Dates lan="en-US" /></div>              
        ...
        <div className="flex container bg-white flex-row items-center overflow-x-auto">
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin"]) ? 'bg-main text-white' : ''}`} href="/admin">
            Dashboard
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/post", "/admin/post/add"]) ? 'bg-main text-white' : ''}`} href="/admin/post">
            News
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/stories", "/admin/stories/add"]) ? 'bg-main text-white' : ''}`} href="/admin/stories">
            Stories
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/videos", "/admin/videos/add"]) ? 'bg-main text-white' : ''}`} href="/admin/videos">
            Videos
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/canvas"]) ? 'bg-main text-white' : ''}`} href="/admin/canvas">
            Canvas
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/category", "/admin/category/add"]) ? 'bg-main text-white' : ''}`} href="/admin/category">
            Category
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/subcategory", "/admin/subcategory/add"]) ? 'bg-main text-white' : ''}`} href="/admin/subcategory">
            SubCategory
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/page", "/admin/page/add"]) ? 'bg-main text-white' : ''}`} href="/admin/page">
            Page
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/city", "/admin/city/add"]) ? 'bg-main text-white' : ''}`} href="/admin/city">
            City
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/area", "/admin/area/add"]) ? 'bg-main text-white' : ''}`} href="/admin/area">
            Area
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/user", "/admin/user/add"]) ? 'bg-main text-white' : ''}`} href="/admin/user">
            User
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/ads"]) ? 'bg-main text-white' : ''}`} href="/admin/ads">
            Ads
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/setting"]) ? 'bg-main text-white' : ''}`} href="/admin/setting">
            Setting
          </Link>
          <Link className={`hover:bg-main hover:text-white p-2 block ${isActive(["/admin/type", "/admin/type/add"]) ? 'bg-main text-white' : ''}`} href="/admin/type">
            Models type
          </Link>
          <Link className="hover:bg-main hover:text-white p-2 block" href="/admin/logout">
            Logout
          </Link>
        </div>
      </div>
